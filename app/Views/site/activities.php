<section class="container breadcrumb">
	<p style="color: var(--black); font-size: 14px"><a href="<?= route('home') ?>" class="text-decoration-none text-black-">Accueil</a> > Actualités > Activités</p>
</section>
		...
		<div class="row posts" x-data="like">
			<div class="col-lg-11 post mx-auto">
				<div class="post_sub">
					...
					<a href="<?= AllConstants()['SITE_URL'].'activity/'.$activity['activitySlug'] ?>" class="text-decoration-none">
					...
					<p style="margin-top: -20px; margin-bottom: 30px;">
						<a href="<?= AllConstants()['SITE_URL'].'activity/'.$activity['activitySlug'] ?>" class="text-decoration-none text-primary- fw-bold">Lire plus</a>
					</p>
					...
					<div class="hstack">
						...
						<div class="ms-auto dropup">
							...
							<ul class="dropdown-menu">
							    <li><a class="dropdown-item" href="mailto:?body=Check out this site http://www.website.com."><i class="uil uil-envelope share_link_i"></i> <span class="share_link">Email</span></a></li>
