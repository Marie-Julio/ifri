<section class="container breadcrumb">
  <p style="color: var(--black); font-size: 14px"><a href="<?= route('home') ?>" class="text-decoration-none text-black-">Accueil</a> > Formation > Master</p>
</section>
...
<section class="container-fluid formation__content" x-data="formation"  x-data="show_licence: false">
	...
	<div class="container">
		<h3 class="text-black-">Les formations de Master</h3>
